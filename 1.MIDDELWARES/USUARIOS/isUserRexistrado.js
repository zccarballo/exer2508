...
const isUserRexistrado = (req,res,next) => {
...
//ESTA CONDICION FAI A EQUIVALENCIA A ENTRAR NA BASE DE DATOS A SOLICITAR
    ...
    let datoEnviadoRexistroErro = {resposta: "Usuario o contraseña incorrectos"}
    ...
    let condicionUsuarioCorrecto = usuario == 'Jose' && email == 'jose@gmail.com';
...
module.exports = isUserRexistrado;